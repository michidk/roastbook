...
import type { BrewsPageData } from '@/routes/brews/-lib/load-brews-page'

type ListData = Extract<BrewsPageData, { readonly view: 'list' }>
type Shot = ListData['result']['items'][number]
...
export function BrewsPage({
  ...
  readonly data: BrewsPageData
  readonly search: BrewsSearch
}) {
