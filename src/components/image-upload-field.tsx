  ...
  return (
    <div className="space-y-4">
          ...
          {images.map((image, index) => (
            <div key={image.preview} className="group relative">
              ...
              <button
                ...
                className="absolute right-2 top-2 flex size-11 items-center justify-center rounded-full bg-foreground/80 text-background opacity-100 transition-opacity [@media(hover:hover)]:size-8 [@media(hover:hover)]:opacity-0 [@media(hover:hover)]:group-hover:opacity-100"
      ...
      <button
        ...
        className={cn(
          "w-full cursor-pointer rounded-lg border-2 border-dashed border-border bg-secondary/35 p-6 text-center transition-colors hover:border-primary/60 hover:bg-secondary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:p-8",
